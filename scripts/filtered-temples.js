...
const temples = [
    ...
    // Added temples
    {
        ...
        area: 34600,
        imageUrl: "https://thumb.wikimedia.org/wikipedia/commons/thumb/9/98/LDS_Laie_Hawaii_Temple_front_view.jpg/500px-LDS_Laie_Hawaii_Temple_front_view.jpg?utm_source=en.wikipedia.org&utm_campaign=parser&utm_content=thumbnail"
    },
    {
        ...
        area: 53997,
        imageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Tokyo_Japan_Temple.jpg"
    },
    {
    ...
    },
    {
        ...
        area: 84360,
        imageUrl: "https://commons.wikimedia.org/wiki/Special:FilePath/Provo_City_Center_Temple.jpg"
    }
];
...
navLinks.forEach((link) => {
    link.addEventListener("click", (event) => {
        ...
        // Update the page heading to match the selected filter
        pageHeading.textContent = link.textContent;

        // Close the mobile nav after a selection is made
...
document.querySelector('#primary-nav a[data-filter="home"]').classList.add("active");
